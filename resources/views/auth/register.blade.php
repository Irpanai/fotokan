    ...
    <div class="w-full max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div class="w-full lg:w-[45%] flex flex-col justify-center py-6">
            <div class="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-xl shadow-gray-200/40">
                ...
                <!-- Google Auth -->
                <button type="button" class="w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-lg transition flex items-center justify-center gap-3 text-sm mb-6">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    @csrf
                    <!-- Role assignment defaults to pembeli for simple unified form -->
